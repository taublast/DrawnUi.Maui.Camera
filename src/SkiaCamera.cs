...
public partial class SkiaCamera : SkiaControl
{
    ...
    /// <summary>
    /// Abort video recording without saving the video file.
    /// Stops recording immediately, discards all recorded data, and resets to normal preview mode.
    /// No events will be triggered on successful abort.
    /// </summary>
    /// <returns>Async task</returns>
